/* an example to ullustrate the difference between reference variable and 
   pointer variable on C++ 

   Credit: https://www.geeksforgeeks.org/passing-by-pointer-vs-passing-by-reference-in-c/
*/
