...
void set(upper_triangular_t *matrix_ptr, int i, int j, int input) {
    int index = 0;
    if (i <= j) {
        index = i*(i+1)/2 + j;
...
int get(upper_triangular_t *matrix_ptr, int i, int j) {
    int index = 0;
    if (i <= j) {
        index = i*(i+1)/2 + j;
...
void display(upper_triangular_t *matrix_ptr) {
    int index = 0;
